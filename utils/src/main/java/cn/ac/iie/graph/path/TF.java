...
//    public CollectionDemos<Integer,ArrayList<Integer>> getUndigraphNodeMap(){
//        CollectionDemos<Integer, ArrayList<Integer>> nodeLink = new CollectionDemos<>();
//        for (int i = 0; i < graph.getVertexList().length; i++) {
//            ArrayList<Integer> matirxValue = new ArrayList<>();
//
...
//        CollectionDemos<Integer,ArrayList<Integer>> hs = new CollectionDemos<>();
